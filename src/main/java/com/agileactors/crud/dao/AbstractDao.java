...
/**
 * Abstract dao that exposes the repository methods to the service layer. The existence of this layer
 * will enable the de-coupling of the service layer with the repository technology.
 *
